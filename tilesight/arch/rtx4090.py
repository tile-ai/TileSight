...
class RTX4090(Arch):
    def __init__(self):
        ...
        self.core = "RTX4090"
        self.sm_count = 128
        # self.base_freq = 3.105 * 1e9
        # self.max_freq = 3.105 * 1e9
        self.base_freq = 2.53 * 1e9
        self.max_freq = 2.53 * 1e9
        # self.base_freq = 2.23 * 1e9 #ncu
        # self.max_freq = 2.23 * 1e9 #ncu
    ...
    def set_to_spec(self):
        ...
        self.l2_bandwidth=5000 * 1e9
        # self.l2_capacity = 40 * (1024**2) # effective cap here; A100 with dup
        self.l2_capacity = 72 * (1024**2) # effective cap here; A100 with dup
    ...
    def set_to_microbench(self):
        ...
        self.ddr_bandwidth = 898.8 * 1e9
        self.l2_bandwidth= 4861.5 *1e9
        self.smem_bandwidth = 34962.3 * 1e9

        self.fp32_cuda_core_flops = 60.95 * 1e12
        self.fp16_cuda_core_flops = 60.95 * 1e12
        self.fp64_cuda_core_flops = 1.174625 * 1e12
        self.fp16_tensor_flops = 324.255 * 1e12
