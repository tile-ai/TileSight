...
class H100_PCIE(Arch):
    def __init__(self):
        ...
        self.core = "H100"
        self.sm_count = 114
        # self.base_freq = 1.755 * 1e9 # 1.83 * 1e9 #1.98 * 1e9
        # self.max_freq = 1.755 * 1e9 # 1.83 * 1e9 #1.98 * 1e9
        self.base_freq = 1.42 * 1e9 # 1.44 * 1e9 for tensorcore
        self.max_freq = 1.42 * 1e9 # 1.83 * 1e9 #1.98 * 1e9
    ...
    def set_to_microbench(self):
        ...
        self.ddr_bandwidth = 1864.22 * 1e9
        self.l2_bandwidth= 7598.48 *1e9
        # self.smem_bandwidth = 37699.2 * 1e9
        self.smem_bandwidth = 20720.6 * 1e9


        self.fp32_cuda_core_flops = 37.82 * 1e12
        self.fp16_cuda_core_flops = 37.61 * 1e12
        self.fp64_cuda_core_flops = 20.07 * 1e12
        self.fp16_tensor_flops = 662.96 * 1e12
    ...
    def set_to_ncu(self):
        ...
        # self.base_freq = 1.755 * 1e9 # 1.83 * 1e9 #1.98 * 1e9
        # self.max_freq = 1.755 * 1e9 # 1.83 * 1e9 #1.98 * 1e9
        self.base_freq = 1.06 * 1e9 # 1.44 * 1e9 for tensorcore
        self.max_freq = 1.06 * 1e9 # 1.83 * 1e9 #1.98 * 1e9
        self.tensor_cores_per_sm = 4
        self.tensor_core_shape = (8, 4, 16) # M,N.K
        self.tensor_core_flops = 1024
        self.fp32_cores_per_sm = 128
...
if __name__ == "__main__":
    h100 = H100_PCIE()
    h100.set_to_spec()
    # h100.set_to_microbench()
    print("h100 fp16 tensor tflops: ", h100.fp16_tensor_flops / 1e12)
    print("h100 fp32 cuda core tflops: ", h100.fp32_cuda_core_flops / 1e12)
    print("h100 fp16 cuda core tflops: ", h100.fp16_cuda_core_flops / 1e12)
    print("h100 fp64 cuda core tflops: ", h100.fp64_cuda_core_flops / 1e12)
    print("h100 int32 cuda core tflops: ", h100.int32_cuda_core_flops / 1e12)
    print("h100 sfu tflops: ", h100.sfu_flops / 1e12)