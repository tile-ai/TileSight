...
class RTX3090(Arch):
    def __init__(self):
        ...
        # self.base_freq = 1.39 * 1e9 #ncu
        # self.max_freq = 1.39 * 1e9 #ncu
        ...
        self.int8_int2_flops = self.fp16_tensor_flops * 1
        ...
        self.fp64_cuda_core_flops = self.sm_count * self.max_freq * self.fp32_cores_per_sm * 2 * 1/64
        ...
        # self.ddr_max_util=808.539857/936
        self.l2_max_util=2345.755191/2722.7
        # self.l2_max_util=2093/2722.7
        # self.l1_max_util=111.728928/128
        # self.compute_max_util=0.95
